"""
Налаштування Django Admin для додатку 'orders'.
"""
...
def export_orders_csv(modeladmin, request, queryset):
    """Дія адмінки: експорт обраних замовлень у CSV."""
...
def mark_delivered(modeladmin, request, queryset):
    """Дія адмінки: позначити обрані замовлення як ДОСТАВЛЕНО."""
...
def mark_processing(modeladmin, request, queryset):
    """Дія адмінки: позначити обрані замовлення як В ОБРОБЦІ."""
...
class OrderAdmin(admin.ModelAdmin):
    ...
    def total_cost_display(self, obj):
        # total_cost використовує попередньо завантажені items — без зайвих запитів
